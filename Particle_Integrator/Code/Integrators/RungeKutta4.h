...
#pragma omp critical(SPICE)
	...
	while (nstate[6] < config_out->final_time)
	{
		...
		dir_SSB[1] = -initPos[1];
		dir_SSB[2] = -initPos[2];
		calc_accel(config_out->N_bodys, config_out->GM, dir_SSB, &body_pre, k_acc_1, config_out->body_int, initVel, config_out->particle_radius, config_out->particle_mass);
		k_vel_1[0] = initVel[0];
		k_vel_1[1] = initVel[1];
		k_vel_1[2] = initVel[2];
...
#pragma omp critical(SPICE)
		...
		calc_accel(config_out->N_bodys, config_out->GM, dir_SSB, &body_mid, k_acc_2, config_out->body_int, initVel, config_out->particle_radius, config_out->particle_mass);
		...
		calc_accel(config_out->N_bodys, config_out->GM, dir_SSB, &body_mid, k_acc_3, config_out->body_int, initVel, config_out->particle_radius, config_out->particle_mass);
		...
		calc_accel(config_out->N_bodys, config_out->GM, dir_SSB, &body_end, k_acc_4, config_out->body_int, initVel, config_out->particle_radius, config_out->particle_mass);
